...
DEFINE_KEYWORD ( TOK_CASE,			"case" )
DEFINE_KEYWORD ( TOK_CONST,			"const" )
DEFINE_KEYWORD ( TOK_DEFAULT,		"default" )
DEFINE_KEYWORD ( TOK_DESCRIPTION,	"description" )
...
DEFINE_KEYWORD ( TOK_INCLUDE,		"include" )
...
DEFINE_KEYWORD ( TOK_SIGNED,		"signed" )
DEFINE_KEYWORD ( TOK_SIZEIS,		"size_is" )
DEFINE_KEYWORD ( TOK_SIZEOF,		"sizeof" )
...
DEFINE_KEYWORD ( TOK_STRUCT,		"struct" )
DEFINE_KEYWORD ( TOK_SWITCHIS,		"switch_is" )
DEFINE_KEYWORD ( TOK_STYLE,			"style" )
DEFINE_KEYWORD ( TOK_TYPEDEF,		"typedef" )
DEFINE_KEYWORD ( TOK_UNION,			"union" )
DEFINE_KEYWORD ( TOK_UNSIGNED,		"unsigned" )
