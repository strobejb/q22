...
TagSet * Parser::ParseTagSet(FILEREF fileRef)
{
	...
	TOKEN allowed[] =
	{
		...
		TOK_ENUM, TOK_ENTRYPOINT, TOK_EXTENT, TOK_OPTIONAL, TOK_EXPORT, TOK_ASSOC, TOK_MAGIC, TOK_OFFSETMAP, TOK_VERSION,
		TOK_DYNAMICARRAY, TOK_DYNAMICCONTAINER, TOK_DYNAMICSTRUCT, TOK_TERMINATEDBY, TOK_VIEW, TOK_FOURCC,
		TOK_NULL
	};
...
int Parser::Parse()
{
	...
	while(t)
	{
		...
		{ 
			...
			TOK_ENDIAN,	TOK_SWITCHIS, TOK_CASE, TOK_NAME, TOK_PADTO, TOK_DEFAULT,
			TOK_ENUM, TOK_ENTRYPOINT, TOK_EXTENT, TOK_OPTIONAL, TOK_EXPORT, TOK_ASSOC, TOK_MAGIC, TOK_OFFSETMAP, TOK_VERSION,
			TOK_DYNAMICARRAY, TOK_DYNAMICCONTAINER, TOK_DYNAMICSTRUCT, TOK_TERMINATEDBY, TOK_VIEW, TOK_TAGS, TOK_FOURCC,
			TOK_NULL 
