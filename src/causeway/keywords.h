...
DEFINE_KEYWORD          ( TOK_ELEMENT,          "element" )
...
DEFINE_KEYWORD          ( TOK_MATCH,            "match" )
...
DEFINE_KEYWORD          ( TOK_OPENAS,           "open_as" )
